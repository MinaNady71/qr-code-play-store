...
class GenerateBarcodeCodabarScreen extends StatefulWidget {

  @override
  State<GenerateBarcodeCodabarScreen> createState() => _GenerateBarcodeCodabarScreenState();
}

class _GenerateBarcodeCodabarScreenState extends State<GenerateBarcodeCodabarScreen> {
             ...
             defaultTextField(
               context: context,
                 ...
                 inputFormatters: <TextInputFormatter>[
                   FilteringTextInputFormatter.allow(RegExp(includeRegExpForCodabar)),
                 ],
            ...
            child: defaultElevatedButton(
                 ...
                 label: 'Generate',
                    onPressed: ()async{
                        ...
                        setState(() {
                    if(controller.text.contains(RegExp(includeRegExpForCodabar)) && controller.text != null && controller.text.length > 0){
                     ...
                     defaultToastMessage(context: context,msg: 'The given text is not valid for the format "Codabar"', color: Color(0xff900e0e));
                    }
