...
class GenerateBarcodeCode39Screen extends StatefulWidget {

  @override
  State<GenerateBarcodeCode39Screen> createState() => _GenerateBarcodeCode39ScreenState();
}

class _GenerateBarcodeCode39ScreenState extends State<GenerateBarcodeCode39Screen> {
            ...
            child: Column(
             ...
             defaultTextField(
                 ...
                 inputFormatters: <TextInputFormatter>[
                   FilteringTextInputFormatter.allow(RegExp(includeRegExpForCode39)),
                 ],
           ...
           alignment: Alignment.bottomRight,
            child: defaultElevatedButton(
                ...
                onPressed: ()async{
                  ...
                  setState(() {
                    if(controller.text.contains(RegExp(includeRegExpForCode39)) && controller.text != null && controller.text.length > 0){
                     ...
                     defaultToastMessage(context: context,msg: 'The given text is not valid for the format "Code 39"', color: Color(0xff900e0e));
                    }
