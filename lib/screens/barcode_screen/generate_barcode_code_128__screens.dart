...
class GenerateBarcodeCode128Screen extends StatefulWidget {

  @override
  State<GenerateBarcodeCode128Screen> createState() => _GenerateBarcodeCode128ScreenState();
}

class _GenerateBarcodeCode128ScreenState extends State<GenerateBarcodeCode128Screen> {
            ...
            child: Column(
             ...
             defaultTextField(
               context: context,
                 ...
                 label: 'text without special characters',
                 textInputType: TextInputType.text,
                 inputFormatters: <TextInputFormatter>[
                   FilteringTextInputFormatter.allow(RegExp(includeRegExpForCode128)),
                 ],
           ...
           alignment: Alignment.bottomRight,
            child: defaultElevatedButton(
                ...
                onPressed: ()async{
                  ...
                  setState(() {
                    if(controller.text.contains(RegExp(includeRegExpForCode128)) && controller.text != null && controller.text.length > 0){
                     ...
                     defaultToastMessage(context: context,msg: 'The given text is not valid for the format "Code 128"', color: Color(0xff900e0e));
                    }
