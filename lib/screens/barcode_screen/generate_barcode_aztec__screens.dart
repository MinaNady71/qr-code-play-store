...
class GenerateBarcodeAztecScreen extends StatefulWidget {

  @override
  State<GenerateBarcodeAztecScreen> createState() => _GenerateBarcodeAztecScreenState();
}

class _GenerateBarcodeAztecScreenState extends State<GenerateBarcodeAztecScreen> {
                ...
                onPressed: ()async{
                  ...
                  setState(() {
                    if( controller.text.length > 0){
                     ...
                     defaultToastMessage(context: context,msg: 'The given text is not valid for the format "Aztec"', color: Color(0xff900e0e));
                    }
