...
class ViewSingleCodeCreatedHistory extends StatelessWidget {

   ViewSingleCodeCreatedHistory({required this.index,Key? key}) ;
late int index ;
  @override
  Widget build(BuildContext context) {
    ...
    String textValue = cubit.createList[index]['name'];
         return Scaffold(
